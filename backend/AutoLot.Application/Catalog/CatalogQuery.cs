...
public sealed record CatalogQuery
{
    ...
    /// <summary>
    /// Лише опубліковані після цієї миті. Потрібен двом: фільтру «нові за
    /// добу» в каталозі й розсилці про нові збіги в збережених пошуках —
    /// саме він робить «нове» вимірюваним.
    /// </summary>
