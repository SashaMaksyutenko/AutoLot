...
Модель даних готова, робота з нею — наступний крок. `Listing` тримає ціну,
місто, статус і умови угоди; технічні характеристики винесені в `Car`,
опції комплектації — у зв'язок «багато до багатьох» із довідником `Feature`
(52 опції в п'яти розділах), країни — у `Country` (46 записів).
